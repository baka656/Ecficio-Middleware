...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["offline-registration-offline-registration-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppOfflineRegistrationOfflineRegistrationPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppOfflineRegistrationOfflineRegistrationRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OfflineRegistrationPageRoutingModule", function () {
      return OfflineRegistrationPageRoutingModule;
    });
    /* harmony import */
    ...
    var _offline_registration_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var OfflineRegistrationPageRoutingModule = function OfflineRegistrationPageRoutingModule() {
      _classCallCheck(this, OfflineRegistrationPageRoutingModule);
    };

    OfflineRegistrationPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppOfflineRegistrationOfflineRegistrationModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OfflineRegistrationPageModule", function () {
      return OfflineRegistrationPageModule;
    });
    /* harmony import */
    ...
    var _offline_registration_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./offline-registration-routing.module */
    "./src/app/offline-registration/offline-registration-routing.module.ts");
    /* harmony import */


    var _offline_registration_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./offline-registration.page */
    "./src/app/offline-registration/offline-registration.page.ts");

    var OfflineRegistrationPageModule = function OfflineRegistrationPageModule() {
      _classCallCheck(this, OfflineRegistrationPageModule);
    };

    OfflineRegistrationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _offline_registration_routing_module__WEBPACK_IMPORTED_MODULE_5__["OfflineRegistrationPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
  ...
  /***/
  function srcAppOfflineRegistrationOfflineRegistrationPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppOfflineRegistrationOfflineRegistrationPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OfflineRegistrationPage", function () {
      return OfflineRegistrationPage;
    });
    /* harmony import */
    ...
    var OfflineRegistrationPage = /*#__PURE__*/function () {
      function OfflineRegistrationPage(us, alrt, fb, router, lc, toastCtrl) {
        _classCallCheck(this, OfflineRegistrationPage);
      ...
      _createClass(OfflineRegistrationPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.us.getString('regSession').then(function (res) {
            if (res == undefined) {
              _this.bo = false;
          ...
          this.us.getUsers().subscribe(function (data) {
            if (data['message'] == 'success') {
              _this.dbUsers = data['data'];
        ...
        key: "authenticate",
        value: function authenticate(pass) {
          var _this2 = this;
              ...
              _this2.us.getPass({
                ...
                if (data['message'] == 'success') {
                  ...
                  if (data['data'] == pass.value) {
                    ...
                    _this2.us.setString('regSession', 'true');
                  } else {
        ...
        value: function createCode() {
          ...
          this.us.validEmail({
            ...
            if (data == true) {
              _this3.userDetails.name = _this3.registrationForm.value.name;
              _this3.userDetails.email = _this3.registrationForm.value.email;
              _this3.userDetails.phone = _this3.registrationForm.value.phone;
              _this3.userDetails.college = _this3.registrationForm.value.college;
              _this3.userDetails.rollno = _this3.registrationForm.value.rollno;
              _this3.userDetails.timestamp = new Date();
              console.log(_this3.userDetails);

              _this3.us.addUser(_this3.userDetails).subscribe(function (baka) {
                if (baka['message'] == 'already exists') {
                  alert("email already registered");
                } else if (baka['message'] == 'success') {
                  alert("receipt:" + baka['receipt']);

                  _this3.router.navigate(['online-registration/', baka['receipt']]);
                } else {
                  alert("some error occured.please try again");
                }
              });
    ...
    OfflineRegistrationPage.ctorParameters = function () {
      return [{
    ...
    OfflineRegistrationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-offline-registration',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./offline-registration.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/offline-registration/offline-registration.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./offline-registration.page.scss */
      "./src/app/offline-registration/offline-registration.page.scss"))["default"]]
    })], OfflineRegistrationPage);
    /***/
  }
}]);
//# sourceMappingURL=offline-registration-offline-registration-module-es5.js.map